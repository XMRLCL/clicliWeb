    ...
    <div class="header-bar" :style="themeStyle()">
        <div class="header-content">
            ...
            <div class="header-right">
                ...
                <div class="icon-btn" @click="goPage('History')">
                  <n-icon class="icon">
                    <history></history>
                  </n-icon>
                  <div class="icon-action">
                    <div class="icon-action-msg">{{ t("common.history") }}</div>
                  </div>
                </div>
                ...
                <div class="icon-btn" @click="goPage('Setting')">
                  <n-icon class="icon">
                    <setting></setting>
                  </n-icon>
                  <div class="icon-action">
                    <div class="icon-action-msg">{{ t("common.setting") }}</div>
                  </div>
                </div>
                <div class="icon-btn" @click="goPage('Space')">
                    <n-icon class="icon">
                        <me></me>
                    </n-icon>
                    <div class="icon-action">
                        <div class="icon-action-msg">{{ t("common.space") }}</div>
                    </div>
                </div>
                <!-- 投稿按钮 -->
                <n-button round color="#fb7299" class="upload-btn" @click="goPage('Upload')">
                    <template #icon>
                        <n-icon>
                            <upload></upload>
                        </n-icon>
...
import { Search as SearchIcon, Upload, Message, Collection, History, Me, Setting } from "@leaf/icons";
