<template>
    <div class="header-bar">
        ...
        <div class="header-user-info">
          ...
          <n-button quaternary text  circle type="primary" @click="goPage('Upload')" style="padding-bottom: 2.5%; margin-left: 11px; margin-right: 10px">
            <template #icon>
              <n-icon size="23px">
                <collection></collection><br>
                <span style="font-size: 50%; margin-left: -20%; font-style:normal; position: relative; top: -60%">{{ t('common.collection') }}</span>
              </n-icon>
            </template>
          </n-button>
          <n-button quaternary text  circle type="primary" @click="goPage('Upload')" style="padding-bottom: 2.5%; margin-left: 20px; margin-right: 20px">
            <template #icon>
              <n-icon size="23px">
                <history></history><br>
                <span style="font-size: 50%; margin-left: -41%; font-style:normal; position: relative; top: -60%">{{ t('common.history') }}</span>
              </n-icon>
            </template>
          </n-button>
          ...
          <n-button quaternary text  circle @click="goPage('Upload')" style="padding-bottom: 2.5%; margin-left: 13px; margin-right: 10px">
            <template #icon>
              <n-icon size="23px">
                <setting></setting><br>
                <span style="font-size: 50%; margin-left: 1%; font-style:normal; position: relative; top: -60%">{{ t('common.setting') }}</span>
              </n-icon>
            </template>
          </n-button>
            <!-- 投稿按钮 -->
            <n-button round color="#fb7299"  @click="goPage('Upload')">
                <template #icon>
                    <n-icon>
                        <upload></upload>
                    </n-icon>
          ...
          <!-- 投稿按钮 -->
<!--          <n-button quaternary type="primary" @click="goPage('Upload')">-->
<!--            <template #icon>-->
<!--            </template>-->
<!--            {{ t("common.contribute") }}-->
<!--          </n-button>-->
...
import {Search as SearchIcon, Upload, MenuOutline, Collection, History, Message, Setting} from "@leaf/icons"
